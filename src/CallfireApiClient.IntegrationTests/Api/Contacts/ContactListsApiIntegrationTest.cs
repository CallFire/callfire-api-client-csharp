...
namespace CallfireApiClient.IntegrationTests.Api.Contacts
{
    ...
    public class ContactListsApiIntegrationTest : AbstractIntegrationTest
    {
        ...
        public void TestContactListCRUD()
        {
            ...
            request.Contacts = new List<string> { "12135543211", "12135678882" };
            request.Name = "listFromNumbers";
            ...
            getItemsRequest.Id = contactList.Id;
            ...
            request2.Contacts = new List<long> { (long)items[0].Id, (long)items[1].Id };
            request.Name = "listFromExistingContacts";
            ...
            updateListRequest.Id = idsListId.Id;
            updateListRequest.Name = "new_name";
        ...
        public void TestContactListItemsCRUD()
        {
            ...
            addItemsRequest.ContactListId = id.Id;
            addItemsRequest.Contacts = new List<string> { "12345543211" };
            Client.ContactListsApi.AddListItems(addItemsRequest);

            GetByIdRequest getItemsRequest = new GetByIdRequest();
            getItemsRequest.Id = id.Id;
            Page<Contact> contactListItems = Client.ContactListsApi.GetListItems(getItemsRequest);
            IList<Contact> items = contactListItems.Items;
